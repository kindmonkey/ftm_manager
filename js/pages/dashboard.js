    ...
    $.ajax({
        ...
        success : function(xml) {
            ...
            $(xml).find("SENSOR").each(function(){
                ...
                loadData($(this).find("MAC").text(), $(this).find("ID").text());
...
function makePanel(_mac) {
    ...
    var thNames = ["ID", "Name", "Type", "Value", "Time", "State", "List"];
    var className = ["col-md-1", "col-md-2", "col-md-2", "col-md-1", "col-md-3", "col-md-2", "col-md-2"];
...
function makeBody(_tbody, _item, _mac) {
    ...
    if (document.getElementById("tr_" + _mac.replace(/"/g, "") + "_" + _item.find("ID").text().replace(/"/g, ""))) {
        ...
        tr.cells[0].innerHTML = _item.find("ID").text();
        tr.cells[1].innerHTML = _item.find("NAME").text();
        tr.cells[2].innerHTML = _item.find("TYPE").text();
        tr.cells[3].innerHTML = values[0];
        tr.cells[4].innerHTML = times[0];
        tr.cells[5].innerHTML = states[0];
    ...
    btn_modify.setAttribute("class", "btn btn-info btn-xs");
    btn_modify.setAttribute("type", "button");
    btn_modify.setAttribute("id", "btn_" + _mac + "_" + _item.find("ID").text());
    btn_modify.appendChild(document.createTextNode("LIST"));
